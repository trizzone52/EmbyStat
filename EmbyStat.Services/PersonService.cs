...
namespace EmbyStat.Services
{
    public class PersonService : IPersonService
    {
        ...
        public PersonService(IPersonRepository personRepository, IShowRepository showRepository, IMovieRepository movieRepository, IMusicRepository musicRepository, IEmbyClient embyClient)
        {
        ...
        public async Task<Person> GetPersonByNameAsync(string name)
        {
            ...
            person.SongCount = _musicRepository.GetSongCountForPerson(person.Id);
